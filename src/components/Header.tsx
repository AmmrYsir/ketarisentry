      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-3.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-medium">Laravel & Microservice Health Sentry</p>
          </div>
        </div>

        {/* Fleet Quick Status Pills */}
        <div className="hidden lg:flex items-center space-x-2.5 bg-slate-950/70 p-1.5 rounded-2xl border border-slate-800/80 shadow-[inset_2px_2px_4px_rgba(0,0,0,0.4)]">
        ...
        <div className="flex items-center space-x-2.5">
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-slate-800 text-slate-300 hover:text-white hover:bg-slate-700 active:scale-95 transition-all shadow-[3px_3px_6px_rgba(0,0,0,0.3)] border border-slate-700/60"
          ...
          <button
            ...
            className={`flex items-center space-x-1.5 px-3 py-2 rounded-xl text-xs font-semibold transition-all shadow-[3px_3px_6px_rgba(0,0,0,0.3)] border active:scale-95 ${
              isPollingActive
          ...
          {user?.role !== 'viewer' && (
            <button
              ...
              className="flex items-center space-x-1.5 px-3.5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold transition-all shadow-[3px_3px_8px_rgba(16,185,129,0.3)] active:scale-95"
            >
          ...
          <label className="p-2.5 rounded-xl bg-slate-800 text-slate-300 hover:text-white hover:bg-slate-700 active:scale-95 transition-all border border-slate-700/60 cursor-pointer" title="Import Fleet Config JSON">
          ...
          {isAuthenticated ? (
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold transition-all active:scale-95 shadow-[3px_3px_8px_rgba(99,102,241,0.3)]"
            >
